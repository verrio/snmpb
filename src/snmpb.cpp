...
#define SNMPB_CONFIG_DIR         ".config/snmpb"
    ...
    if (!SnmpbDir.exists())
    {
        if(!SnmpbDir.mkdir(SnmpbDir.absolutePath()))
        {
            QString err = QString("cannot create configuration directory : %1\n")
                          .arg(SnmpbDir.absolutePath().toUtf8().data());
...
"<H2><b>snmpb</b></H2><br>                                                       \
Version %1<br>                                                                   \
<a href=https://github.com/verrio/snmpb>                                         \
https://github.com/verrio/snmpb</a><br><br>                                      \
                                                                                 \
Copyright (c) <b>Martin Jolicoeur and contributors</b>, 2004-2017<br><br>        \
                                                                                 \
...
%3 (<a href=http://openssl.org>http://openssl.org</a>)<br>                      \
...
QT v%6 (<a href=http://qt.io>http://qt.io</a>)")
        ...
        .arg(OpenSSL_version(SSLEAY_VERSION))
