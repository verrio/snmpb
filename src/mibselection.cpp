...
MibSelection::MibSelection(Snmpb *snmpb, QWidget *parent, QString title, int _flags)
{
    ...
    dprompt->setWindowTitle(tr(title.toUtf8().data()));
...
void MibSelection::OKButtonPressed(void)
{
    ...
    switch (result_syntax)
    {
        ...
        case sNMP_SYNTAX_BITS: /* Obsoleted ? */
            {
                ...
                OctetStr octetstr(result_string.toUtf8().data());
        ...
        case sNMP_SYNTAX_OPAQUE:
            {
                syntax = "OPAQUE";
                OpaqueStr opaquestr(result_string.toUtf8().data());
        ...
        case sNMP_SYNTAX_OID:
            {
                ...
                Oid oid(result_string.toUtf8().data());
        ...
        case sNMP_SYNTAX_IPADDR:
            {
                syntax = "IP ADDRESS";
                IpAddress ipaddress(result_string.toUtf8().data());
...
bool MibSelection::run(const QString& init_oid, int init_syntax, const QString& init_val)
{
    ...
    if (dprompt->exec())
    {
        ...
        vb.set_oid(Oid(tmpoid.toUtf8().data()));
