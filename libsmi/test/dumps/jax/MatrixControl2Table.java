 ...
 *
 * $Id: MatrixControl2Table.java 4432 2006-05-29 16:21:11Z strauss $
 */

/**
    This class represents a Java AgentX (JAX) implementation of
    the table matrixControl2Table defined in RMON2-MIB.
...
public class MatrixControl2Table extends AgentXTable
{

    // entry OID
    private final static long[] OID = {1, 3, 6, 1, 2, 1, 16, 6, 4, 1};
    ...
    public MatrixControl2Table(boolean shared)
    {
        super(shared);
    ...
    public AgentXVarBind getVarBind(AgentXEntry entry, long column)
    {
        ...
        switch ((int)column) {
        case 1: // matrixControlDroppedFrames
        {
            long value = ((MatrixControl2Entry)entry).get_matrixControlDroppedFrames();
            return new AgentXVarBind(oid, AgentXVarBind.COUNTER32, value);
        }
        case 2: // matrixControlCreateTime
        {
            long value = ((MatrixControl2Entry)entry).get_matrixControlCreateTime();
